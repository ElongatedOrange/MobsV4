...
import me.orange.mobsv4.listeners.DragonFlyListener;
...
public class DragonMob extends BaseMob {
    ...
    public ArrayList<String> getLore(Player player) {
        ...
        lore.add("  §7(" + MobsV4.COOLDOWNS.getCooldown(name + "-Alt", player) + "s)");
        lore.add("");
        lore.add("  " + getPrefix() + "🐉 Dragon's Acid §8(Crouch)");
        lore.add("  §fSpawn Dragon's Acid around you");
        lore.add("  §7(" + MobsV4.COOLDOWNS.getCooldown(name + "-Alt2", player) + "s)");
    ...
    public void perform(Player p) {
        ...
        }.runTaskLater(MobsV4.MOBS, 20L * 5); // 5 seconds
    }
    ...
    public Boolean performAlt2(Player player) {
        ...
        }.runTaskTimer(MobsV4.MOBS, 0L, 20L); // Schedule to run every second
        ...
        }.runTaskLater(MobsV4.MOBS, 20L * durationInSeconds);
